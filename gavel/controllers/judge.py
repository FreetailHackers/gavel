...
def index():
    ...
    if annotator is None:
        ...
        if annotator.next is None:
            ...
            return render_template('begin.html', item=annotator.next, content=utils.render_markdown(settings.BEGIN_MESSAGE))
        else:
            return render_template('vote.html', prev=annotator.prev, next=annotator.next, content=utils.render_markdown(settings.VOTE_MESSAGE))
